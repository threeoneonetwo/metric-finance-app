  ...
  return (
    <div
      ...
      style={{
        ...
        transition: `opacity .6s cubic-bezier(0.16,1,0.3,1) ${delay}ms, transform .6s cubic-bezier(0.16,1,0.3,1) ${delay}ms`,
      }}
    >
      {children}
    </div>
  ...
  return (
    <div className={arimo.className} style={{ minHeight: "100vh", background: "#04070d", color: "#f2f5fa" }}>
      <style>{`
        ...
        .brief-metric:hover, .brief-portfolio-stat:hover { background-color: #0d1424; }
        .brief-pick:hover { transform: translateY(-3px); border-color: #27365a; }
        .brief-catalyst:hover { transform: translateY(-2px); border-color: #27365a; background-color: #0c1322; }
      ...
      <header className="brief-header" style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: "24px", background: "#0b1120", borderBottom: "1px solid #16203a" }}>
        <Link href="/" style={{ display: "flex", alignItems: "center", gap: "10px" }}>
          <MetricLogo size={20} className="brief-logo-badge" />
      ...
      <main style={{ maxWidth: "860px", margin: "0 auto", padding: "56px 32px 96px" }}>
        ...
        <Reveal>
          <div className="brief-chart-wrap" style={{ borderRadius: "14px", overflow: "hidden", border: "1px solid #16203a", marginBottom: "44px" }}>
            <BriefChart label="WTI crude, last 30 sessions" height={320} series={[{ points: WTI_HERO, color: "#ff9aa8", fill: true, name: "WTI crude ($)" }]} />
          </div>
        </Reveal>
        ...
        <Reveal>
          <section style={{ marginTop: "48px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", border: "1px solid #16203a", borderRadius: "14px", overflow: "hidden", background: "#0a101d", marginBottom: "20px" }}>
              {METRICS.map((m) => (
                <div key={m.label} className="brief-metric" style={{ padding: "20px 22px", borderLeft: "1px solid #16203a", marginLeft: "-1px" }}>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: "16px", marginBottom: "20px" }}>
              <div>
                <div className="brief-chart-wrap" style={{ borderRadius: "12px", overflow: "hidden", border: "1px solid #16203a" }}>
                  <BriefChart label="WTI crude, trailing twelve months" height={190} series={[{ points: WTI_12MO, color: "#ff9aa8", fill: true, name: "WTI crude ($)" }]} />
                </div>
              ...
              <div>
                <div className="brief-chart-wrap" style={{ borderRadius: "12px", overflow: "hidden", border: "1px solid #16203a" }}>
                  <BriefChart
                    ...
                    height={190}
                    series={[{ points: SOX_INDEXED, color: "#8fb0ff", name: "SOX (indexed)" }, { points: TENYR_INDEXED, color: "#ff9aa8", name: "10-year yield (indexed)" }]}
                  />
                </div>
          ...
          <section style={{ marginTop: "48px" }}>
            ...
            <div style={{ border: "1px solid #27365a", borderRadius: "14px", background: "#0c1322", padding: "26px 24px", marginBottom: "24px" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", border: "1px solid #1e2b49", borderRadius: "11px", overflow: "hidden", background: "#0a101d" }}>
                {PORTFOLIO.map((p) => (
                  <div key={p.label} className="brief-portfolio-stat" style={{ padding: "16px 18px", borderLeft: "1px solid #1e2b49", marginLeft: "-1px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "16px" }}>
              {PICKS.map((p, index) => (
                <Reveal key={p.ticker} delay={index * 70}>
                  <div className="brief-pick" style={{ border: "1px solid #16203a", borderRadius: "14px", background: "#0a101d", overflow: "hidden" }}>
        ...
        <Reveal>
          <section style={{ marginTop: "48px" }}>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "10px" }}>
              {CATALYSTS.map((c) => (
                <div key={`${c.when}-${c.ticker}`} className="brief-catalyst" style={{ padding: "18px 20px", border: "1px solid #16203a", borderRadius: "11px", background: "#0a101d" }}>
        ...
        <Reveal>
          <section className="brief-chart-wrap" style={{ marginTop: "48px", border: "1px solid #27365a", borderRadius: "14px", background: "#0c1322", overflow: "hidden" }}>
            <div style={{ borderBottom: "1px solid #27365a" }}>
              <BriefChart
                label="Semis (red) vs industrials (blue), indexed — the divergence the take is about"
                height={200}
                series={[{ points: TAKE_SEMIS, color: "#ff9aa8", name: "Semis (SOX, indexed)" }, { points: TAKE_INDUSTRIALS, color: "#8fb0ff", name: "Industrials (indexed)" }]}
              />
            </div>
